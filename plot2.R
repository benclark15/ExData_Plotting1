...
## Print Plot 2 - Please note I can only put day names in Spanish
## as I am in Chile and my OS does not allow me to change locale
png("plot2.png", width = 480, height = 480)
plot(energy_ds$Date_Time, energy_ds$Global_active_power,type = "l", xlab = "", ylab = "Global Active Power (kilowatts)")
dev.off()
